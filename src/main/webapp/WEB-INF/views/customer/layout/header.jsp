                           ...
                           <li>
                              <c:choose>
                                    <c:when test = "${isLogined}">
                                      <div class="dropdown">
                                        <button class="dropdown-toggle" style="padding: 0; border: none; background-color: #F8F9FA;" type="button" id="dropdownMenuButton1" data-bs-toggle="dropdown" aria-expanded="false">
